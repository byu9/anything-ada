...
package System.Unsigned_Types is
   ...
   function Shift_Left
     (Value : Short_Short_Unsigned; Amount : Natural)
      return Short_Short_Unsigned with
      Import,
   ...
   function Shift_Left
     (Value : Short_Unsigned; Amount : Natural) return Short_Unsigned with
      Import,
      Convention => Intrinsic;
   ...
   function Shift_Left
     (Value : Unsigned; Amount : Natural) return Unsigned with
      Import,
      Convention => Intrinsic;
   ...
   function Shift_Left
     (Value : Long_Unsigned; Amount : Natural) return Long_Unsigned with
      Import,
      Convention => Intrinsic;
   ...
   function Shift_Left
     (Value : Long_Long_Unsigned; Amount : Natural)
      return Long_Long_Unsigned with
      Import,
      Convention => Intrinsic;
   ...
   function Shift_Left
     (Value : Long_Long_Long_Unsigned; Amount : Natural)
      return Long_Long_Long_Unsigned with
      Import,
      Convention => Intrinsic;
