...
is
   ...
   function Shift_Left
     (Value : Unsigned_8; Amount : Natural) return Unsigned_8 with
      Import,
   ...
   function Shift_Left
     (Value : Unsigned_16; Amount : Natural) return Unsigned_16 with
      Import,
      Convention => Intrinsic,
      Static;
   ...
   function Shift_Left
     (Value : Unsigned_32; Amount : Natural) return Unsigned_32 with
      Import,
      Convention => Intrinsic,
      Static;
   ...
   function Shift_Left
     (Value : Unsigned_64; Amount : Natural) return Unsigned_64 with
      Import,
      Convention => Intrinsic,
      Static;
   ...
   function Shift_Left
     (Value : Unsigned_128; Amount : Natural) return Unsigned_128 with
      Import,
      Convention => Intrinsic,
      Static;
